...
<div>
    <div class="row">
        <nav class="col-sm-3 col-lg-2 m-5">
            <a href="index.php"><button type="button" class="btn btn-outline-secondary col-12">Home</button></a>
            <?php
        ...
        <section class="m-5 col-lg-8">
            ...
            if(isset($_GET['add'])){
                ...
                echo "<h2>$table[prenom] ".strtoupper( $table[nom])."</h2>";
                echo "<p>$table[age] ans, je mesure $table[taille]m et je fais partie des $table[situation]s de la promo Simplon</p><br>";
